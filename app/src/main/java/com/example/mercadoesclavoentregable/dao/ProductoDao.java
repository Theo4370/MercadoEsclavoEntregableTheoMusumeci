...
public abstract class ProductoDao extends RetrofitDao {
    ...
    public void getProductoPorSearchPaginado(String producto, Integer offset, Integer limit, final ResultListener<ProductoContainer> resultListenerPorController) {
        Call<ProductoContainer> call = this.productoService.getProductoPorSearchPaginado(producto, offset, limit);
